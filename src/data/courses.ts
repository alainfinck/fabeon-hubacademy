...
<ul><li><code>MACHINE_SUPPORT_QUALITE_vX</code></li><li>Exemple : <code>LATEX700_DIBOND3mm_PHOTO_v2</code></li></ul>`,
  ...
  {
    id: 'ia-visuels-generatifs',
    slug: 'ia-visuels-generatifs-impression',
    title: 'IA — Visuels génératifs pour l\'impression',
    subtitle: 'Mockups, moodboards et variantes BAT assistés par IA',
    description:
      'Maîtrisez les outils génératifs (Midjourney, DALL·E, Adobe Firefly) pour produire des visuels exploitables en grand format : résolution, colorimétrie, retouches et validation avant RIP.',
    category: 'ia',
    level: 'debutant',
    format: 'en-ligne',
    duration: 300,
    lessonsCount: 10,
    instructor: 'Julien Arnaud',
    instructorRole: 'Directeur créatif & formateur IA print',
    tags: ['IA', 'Générative', 'Mockups', 'BAT'],
    featured: true,
    price: '399 € HT',
    software: ['Midjourney', 'Adobe Firefly', 'Photoshop génératif'],
    imageGradient: 'from-fuchsia-500 via-violet-600 to-indigo-900',
    objectives: [
      'Rédiger des prompts efficaces pour l\'impression grand format',
      'Exporter des visuels à la bonne résolution et colorimétrie',
      'Intégrer l\'IA dans un workflow BAT client → atelier',
      'Identifier les limites légales et éthiques (droits d\'auteur, marques)',
    ],
    prerequisites: ['Notions de PAO ou communication visuelle'],
    modules: [
      {
        id: 'm1',
        title: 'Prompting & cadrage créatif',
        lessons: [
          {
            id: 'l1-1',
            title: 'Panorama des outils IA créatifs',
            duration: 25,
            type: 'video',
            description: 'Midjourney, Firefly, Stable Diffusion — usages print.',
          },
          {
            id: 'l1-2',
            title: 'Prompts pour signalétique et retail',
            duration: 30,
            type: 'pratique',
            description: 'Structures de prompt, styles, contraintes formats.',
          },
        ],
      },
      {
        id: 'm2',
        title: 'Production & RIP',
        lessons: [
          {
            id: 'l2-1',
            title: 'Upscale et préparation fichier',
            duration: 35,
            type: 'video',
            description: 'Résolution, profils ICC et zones de fond perdu.',
          },
          {
            id: 'l2-2',
            title: 'Quiz — Workflow IA → impression',
            duration: 10,
            type: 'quiz',
            description: 'Valider la chaîne de production.',
          },
        ],
      },
    ],
  ...
  {
    id: 'ia-workflow-atelier',
    slug: 'ia-workflow-automatisation-atelier',
    title: 'IA — Automatisation du workflow atelier',
    subtitle: 'Devis, nomenclatures, nesting assisté et reporting',
    description:
      'Connectez l\'IA à votre quotidien d\'atelier : génération de devis, extraction de specs client, suggestions de nesting et synthèses de production pour équipes multi-machines.',
    category: 'ia',
    level: 'intermediaire',
    format: 'hybride',
    duration: 360,
    lessonsCount: 12,
    instructor: 'Nadia Benali',
    instructorRole: 'Consultante workflow & IA opérationnelle',
    tags: ['IA', 'Automatisation', 'Nesting', 'Productivité'],
    featured: true,
    price: '449 € HT',
    software: ['ChatGPT Teams', 'Caldera', 'Notion / API'],
    imageGradient: 'from-violet-500 via-purple-600 to-slate-900',
    objectives: [
      'Automatiser la prise en charge des briefs clients',
      'Générer des checklists qualité et rapports Delta E',
      'Piloter des scripts IA autour du RIP et des hotfolders',
    ],
    prerequisites: ['Pilotage imprimante GF ou ONYX'],
    modules: [
      {
        id: 'm1',
        ...
        lessons: [
          {
            id: 'l1-1',
            title: 'Assistants IA pour l\'atelier',
            duration: 30,
            type: 'video',
            description: 'Cas d\'usage réels : devis, mails, specs techniques.',
          },
          {
            id: 'l1-2',
            title: 'Session live — Scripts & hotfolders',
            duration: 45,
            type: 'pratique',
            description: 'Démonstration hybride avec Caldera.',
          },
        ],
      },
    ],
  ...
  {
    id: 'ia-lab-signalétique',
    slug: 'ia-lab-signalétique-presentiel',
    title: 'Lab IA — Signalétique & PLV',
    subtitle: 'Journée présentielle : concept IA → prototype imprimé',
    description:
      'Atelier IA en salle : du brief client au prototype signalétique en une journée — prompting, retouches, impression test et découpe sur machines du HubAcademy.',
    category: 'ia',
    level: 'intermediaire',
    format: 'atelier-ia',
    duration: 480,
    ...
    instructor: 'Julien Arnaud',
    instructorRole: 'Directeur créatif & formateur IA print',
    tags: ['IA', 'PLV', 'Signalétique', 'Présentiel'],
    featured: true,
    price: '720 € HT',
    equipment: ['Postes IA', 'HP UV', 'Zünd G3', 'Forex & Dibond'],
    software: ['Midjourney', 'Photoshop', 'Caldera'],
    imageGradient: 'from-fuchsia-600 to-violet-800',
    objectives: [
      'Produire 3 variantes créatives assistées par IA',
      'Valider colorimétrie et fonds perdus avant impression',
      'Livrer un prototype PLV découpé en fin de journée',
    ],
    prerequisites: ['Notions PAO ou expérience signalétique'],
    modules: [
      {
        id: 'm1',
        title: 'Lab journée complète',
        lessons: [
          {
            id: 'l1-1',
            title: 'Brief & prompting collectif',
            duration: 90,
            type: 'pratique',
            description: 'Atelier matin : concepts et sélection visuels.',
          },
          {
            id: 'l1-2',
            title: 'Impression & découpe prototype',
            duration: 120,
            type: 'pratique',
            description: 'Atelier après-midi sur machines réelles.',
          },
        ],
      },
    ],
  ...
  {
    id: 'ia-retouche-upscale',
    slug: 'ia-retouche-upscale-grand-format',
    title: 'IA — Retouche & upscale grand format',
    subtitle: 'Topaz, Firefly et workflows sans perte qualité',
    description:
      'Agrandissez et nettoyez des visuels clients basse résolution grâce à l\'IA : débruitage, upscale intelligent, extension de canvas et préparation RIP sans artefacts.',
    category: 'ia',
    level: 'avance',
    format: 'en-ligne',
    duration: 240,
    lessonsCount: 8,
    instructor: 'Sophie Maréchal',
    instructorRole: 'Coloriste & experte prépresse IA',
    tags: ['IA', 'Upscale', 'Retouche', 'Qualité'],
    featured: false,
    price: '329 € HT',
    software: ['Topaz Gigapixel', 'Adobe Firefly', 'Photoshop'],
    imageGradient: 'from-indigo-500 to-fuchsia-700',
    objectives: [
      'Choisir la bonne chaîne upscale selon le support',
      'Éviter les artefacts visibles en grand format',
      'Documenter les transformations pour le client',
    ],
    prerequisites: ['Calibration des couleurs — bases recommandées'],
    modules: [
      {
        id: 'm1',
        title: 'Upscale & qualité',
        lessons: [
          {
            id: 'l1-1',
            title: 'Comparatif des moteurs IA',
            duration: 25,
            type: 'video',
            description: 'Topaz, Real-ESRGAN, Firefly — critères de choix.',
          },
          {
            id: 'l1-2',
            title: 'Contrôle qualité avant RIP',
            duration: 30,
            type: 'pratique',
            description: 'Zones à risque, textes, dégradés.',
          },
        ],
      },
    ],
